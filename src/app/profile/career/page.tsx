...
export default function CareerDevelopment() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F8F6FF] to-white p-4 md:p-6 lg:p-8">
                  ...
                  <div className="flex flex-col md:flex-row gap-4 justify-between mb-4">
                    ...
                    <div className="flex flex-col items-end gap-3">
                      <div className="text-right">
                        <div className="text-2xl font-bold text-[#5B5BE7] mb-1">{goal.progress}%</div>
                ...
                <div key={assessment.id} className="bg-white rounded-2xl p-6 shadow-sm border border-[#E8E4FF] hover:shadow-lg transition-all duration-300">
                  <div className="flex flex-col md:flex-row gap-4 justify-between">
                    <div className="flex gap-4">
                      <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#5B5BE7] to-[#B14BE4] text-white font-bold text-lg flex items-center justify-center">
                        <FiAward size={24} />
                      </div>
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className="px-3 py-1 bg-[#F3EFFF] text-[#8B2AE2] text-sm font-bold rounded-full">
                            {assessment.badge}
                          </span>
                        </div>
                        <div className="flex items-center gap-4 text-sm text-[#666]">
                    ...
                    <div className="flex flex-col items-end gap-3">
                      <div className="text-right">
                        <div className="text-3xl font-bold text-[#5B5BE7] mb-1">{assessment.score}</div>
            ...
            <div className="grid gap-6">
              {learningPaths.map((path) => (
                <div key={path.id} className="bg-white rounded-2xl p-6 shadow-sm border border-[#E8E4FF] hover:shadow-lg transition-all duration-300">
                  <div className="flex flex-col md:flex-row gap-4 justify-between">
                    <div className="flex gap-4">
                      <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#B14BE4] to-[#921294] text-white font-bold text-lg flex items-center justify-center">
                        <FiBookOpen size={24} />
                      </div>
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-4 text-sm text-[#666] mb-3">
                          ...
                          <span className="px-2 py-1 bg-[#F3EFFF] text-[#8B2AE2] text-xs font-medium rounded-lg">
                            {path.category}
                          </span>
