...
export default function RecruiterInsights() {
  ...
  const insights: RecruiterInsight[] = [
    ...
    },
    {
      ...
      description:
        "Your expected salary range is 15% above market average for your experience level in Bangalore.",
      category: "salary",
      priority: "medium",
      date: "2024-01-14",
    },
                ...
                {marketTrends.map((trend, index) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#5B5BE7] to-[#B14BE4] text-white text-sm font-bold flex items-center justify-center">
                        {index + 1}
                      </div>
                      <div>
