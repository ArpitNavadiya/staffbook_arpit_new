...
export default function Messages() {
  ...
  const getMessageStatusIcon = (status: string) => {
    switch (status) {
      ...
      case "delivered":
        return <FiCheck size={14} className="text-[#666]" />;
      case "read":
        return <FiCheck size={14} className="text-[#5B5BE7]" />;
      default:
        return null;
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F8F6FF] to-white p-4 md:p-6 lg:p-8 mt-16">
              ...
              <div className="p-4 border-b border-[#E8E4FF]">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-[#E8E4FF] rounded-lg focus:outline-none focus:border-[#B14BE4] transition-colors duration-300"
                  />
                </div>
              </div>
              ...
              <div className="flex-1 overflow-y-auto">
                {conversations.map((conversation) => (
                  <div
                    ...
                    className={`p-4 border-b border-[#F3EFFF] cursor-pointer hover:bg-[#F8F6FF] transition-colors duration-300 ${
                      selectedConversation === conversation.id
                        ? "bg-[#F8F6FF] border-l-4 border-l-[#5B5BE7]"
                        : ""
                    }`}
                  >
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {conversation.unreadCount > 0 && (
                          <div className="inline-flex items-center justify-center w-5 h-5 bg-[#5B5BE7] text-white text-xs font-bold rounded-full">
                ...
                <>
                  ...
                  <div className="p-4 border-b border-[#E8E4FF] flex justify-between items-center">
                    <div className="flex items-center gap-3">
                      <div className="relative">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#5B5BE7] to-[#B14BE4] text-white font-bold flex items-center justify-center">
                    ...
                    <div className="flex gap-2">
                      <button className="p-2 rounded-lg hover:bg-[#F8F6FF] transition-colors duration-300">
                    ...
                    <div className="flex gap-3 items-end">
                      ...
                      <div className="flex-1 relative">
                        <input
                          ...
                          className="w-full px-4 py-3 border border-[#E8E4FF] rounded-xl focus:outline-none focus:border-[#B14BE4] transition-colors duration-300"
                          onKeyPress={(e) =>
                      ...
                      <button
                        ...
                        className="p-3 bg-gradient-to-r from-[#5B5BE7] to-[#B14BE4] hover:from-[#4A4AD6] hover:to-[#A13BD3] text-white rounded-xl transition-all duration-300 transform hover:scale-105"
                      >
                        <FiSend size={18} />
                      </button>
                    </div>
